...
const CButton = forwardRef((props:ButtonProps, ref:ForwardedRef<HTMLButtonElement>) => {
  return (
    <Button
      disableRipple
      ref={ref}
      sx={{...props.style,
        ...
        color: 
          ...
          props.type === 'lightgray' ? 'grayBtn.contrastText' : 
          props.type === 'blueBorder' ? 'blueBtn.main' : '',
      }}
